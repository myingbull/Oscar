// ==UserScript==
// @name        Allergies and Preventions
...
//  myWindow = window.open(vPath + 'oscarPrevention/AddPreventionData.jsp?prevention=Flu&demographic_no=' + demoNo + '&prevResultDesc=&flushot', 'myWindow', 'width=800, height=600');
 myWindow = window.open(vPath + 'oscarPrevention/AddPreventionData.jsp?prevention=Flu&displayName=Flu&demographic_no=' + demoNo + '&prevResultDesc=&product=FluLaval Tetra&lot=45LM9&site=Right deltoid', 'myWindow', 'width=800, height=600');
}

var input3 = document.createElement('input');
input3.type = 'button';
input3.value = 'Pap';
input3.onclick = ButtonFunction4;
input3.setAttribute('style', 'font-size:8px;position:absolute;top:32px;left:135px;background-color: #FFC0CB;');
document.body.appendChild(input3);

function ButtonFunction4() {
  y = (30 / 86400) //5 seconds
  setCookie('RELOAD', 'RELOADED', y, 'path=/') //alert(input202.value)
//  myWindow = window.open(vPath + 'oscarPrevention/AddPreventionData.jsp?prevention=PAP&demographic_no=' + demoNo + '&prevResultDesc=&PAP', 'myWindow', 'width=800, height=600');
 myWindow = window.open(vPath + 'oscarPrevention/AddPreventionData.jsp?prevention=PAP&displayName=PAP&demographic_no=' + demoNo, 'myWindow', 'width=800, height=600');
}
